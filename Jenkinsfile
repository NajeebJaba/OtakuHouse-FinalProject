// run with post but without indepentent
// pipeline {
//     agent any
//     environment {
//         VENV_DIR = 'venv'
...
//The code is running without indepenting and post
// pipeline {
//     agent any
//     environment {
//         VENV_DIR = 'venv'
...
pipeline {
    ...
    stages {
        ...
        // The 'Install Dependencies' stage has been removed.
    }
    // 'Declarative Post Actions' has been removed.
}
